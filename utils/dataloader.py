...
if __name__ == "__main__":
    ...
    train_loader = create_dataloader(train_dir, data_config, "train", batch_size, num_workers)
    test_loader = create_dataloader(test_dir, data_config, "test", batch_size, num_workers)
